...
class MainPage(Frame):
    def __init__(self, parent, controller):
        ...
        self.heading_button_frame = header_buttons_frame(controller.heading_frame, controller)
        ...
        _ = [self.tabControl.add(x, text=x_name) for x, x_name in zip(self.tabs, controller.app.topics)]
        ...
        self.trees = self.get_trees(self.main_frame_left, controller)
        self.switch_topics_tree(self.get_tab_name())

        self.filter_frame = FilterFrame(self.highside_frame, controller.root)
        self.add_link_frame = AddLinkFrame(self.highside_frame, controller.root)
